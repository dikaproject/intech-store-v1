...
<head>
    ...
    <title>Intech-Commerce || Login</title>
            ...
            <div class="minimal-card-wrapper">
                <div class="card mb-4 mt-5 mx-4 mx-sm-0 position-relative">
                    ...
                    <div class="card-body p-sm-5">
                        ...
                        <p class="fs-12 fw-medium text-muted">Please login to access your account.</p>
                        ...
                        <div class="w-100 mt-5 text-center mx-auto">
                            ...
                            <div class="d-flex align-items-center justify-content-center gap-2">
                                <a href="#" class="btn btn-light-brand flex-fill" title="Login with Facebook">
                                    <i class="feather-facebook"></i>
                                </a>
                                <a href="#" class="btn btn-light-brand flex-fill" title="Login with Twitter">
                                    <i class="feather-twitter"></i>
                                </a>
                                <a href="#" class="btn btn-light-brand flex-fill" title="Login with Github">
